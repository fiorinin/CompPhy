...
include ('utils.php');
set_INC ('compphy/ckeditor/ckfinder/');
/**
...
function CheckAuthentication()
{
	...
	// return isset($_SESSION['IsAuthorized']) && $_SESSION['IsAuthorized'];
        return isset($_SESSION['authAdminValue']) && $_SESSION['authAdminValue'] == APASS;
...
*/
$baseUrl = ROOT.'/compphy/ckeditor/ckfinder/files/';
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = ROOTPATH.'/compphy/ckeditor/ckfinder/files/';
